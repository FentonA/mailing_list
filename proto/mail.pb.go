...
type GetEmailRequestResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetEmailRequestResponse) Reset() {
	*x = GetEmailRequestResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetEmailRequestResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetEmailRequestResponse) ProtoMessage() {}

func (x *GetEmailRequestResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_mail_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetEmailRequestResponse.ProtoReflect.Descriptor instead.
func (*GetEmailRequestResponse) Descriptor() ([]byte, []int) {
	return file_proto_mail_proto_rawDescGZIP(), []int{7}
}

func (x *GetEmailRequestResponse) GetEmailEntries() []*EmailEntry {
	if x != nil {
...
var file_proto_mail_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x61, 0x69, 0x6c, 0x5f, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x51, 0x0a, 0x17, 0x47,
	0x65, 0x74, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65,
	...
	0x52, 0x0c, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x32, 0xd5,
	0x02, 0x0a, 0x0b, 0x6d, 0x61, 0x69, 0x6c, 0x69, 0x6e, 0x67, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x40,
	...
	0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2e, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x12, 0x44, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x42, 0x61, 0x74, 0x63,
	0x68, 0x12, 0x1b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47, 0x65, 0x74, 0x45, 0x6d, 0x61,
	0x69, 0x6c, 0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14,
...
var file_proto_mail_proto_goTypes = []interface{}{
	...
	(*GetEmailRequestResponse)(nil), // 7: proto.GetEmailRequestResponse
}
var file_proto_mail_proto_depIdxs = []int32{
	...
	0, // 2: proto.GetEmailRequestResponse.email_entries:type_name -> proto.EmailEntry
	...
	5, // 7: proto.mailinglist.GetEmailBatch:input_type -> proto.GetEmailBatchRequest
	...
	6, // 12: proto.mailinglist.GetEmailBatch:output_type -> proto.EmailResponse
...
func file_proto_mail_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_mail_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetEmailRequestResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
